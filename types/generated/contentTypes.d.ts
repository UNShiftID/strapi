...
export interface ApiComplainComplain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    complain_status: Schema.Attribute.Enumeration<
      ['submitted', 'processed', 'success', 'rejected']
    >;
    description: Schema.Attribute.Text;
    order: Schema.Attribute.Relation<'oneToOne', 'api::order.order'>;
    problem: Schema.Attribute.Enumeration<
      ['damaged', 'lost', 'unmatched', 'deficient']
    >;
    solution: Schema.Attribute.Enumeration<
      ['return', 'refund', 'change', 'reship']
    >;
    amount: Schema.Attribute.Decimal;
    reject_reason: Schema.Attribute.Text;
    refund_account_name: Schema.Attribute.String;
    refund_account_number: Schema.Attribute.String;
    refund_channel: Schema.Attribute.String;
    store_address: Schema.Attribute.Text;
    shipment_tracking_number: Schema.Attribute.String;
    shipment_vendor: Schema.Attribute.String;
    proof: Schema.Attribute.Media<
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    order_status: Schema.Attribute.Enumeration<
      ['pending', 'delivery', 'arrived', 'return']
    >;
    total: Schema.Attribute.Decimal;
    shipment_vendor: Schema.Attribute.Blocks;
    shipment_tracking_number: Schema.Attribute.Blocks;
    number: Schema.Attribute.String;
    quantity: Schema.Attribute.BigInteger;
    unit_price: Schema.Attribute.Decimal;
    arrived_at: Schema.Attribute.DateTime;
    product: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    transaction: Schema.Attribute.Relation<
      'manyToOne',
      'api::transaction.transaction'
    >;
    order_variants: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-variant.order-variant'
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderVariantOrderVariant
  extends Struct.CollectionTypeSchema {
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    variant_groups: Schema.Attribute.Relation<
      'oneToMany',
      'api::variant-group.variant-group'
    >;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cancel_at: Schema.Attribute.DateTime;
    ...
    shipping_village: Schema.Attribute.String;
    shipping_address: Schema.Attribute.String;
    shipping_postal: Schema.Attribute.String;
    total: Schema.Attribute.Decimal;
    discount: Schema.Attribute.Decimal;
...
export interface ApiVariantVariant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<
      ...
      true
    >;
    variant_group: Schema.Attribute.Relation<
      'manyToOne',
      'api::variant-group.variant-group'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiVariantGroupVariantGroup
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::order-variant.order-variant': ApiOrderVariantOrderVariant;
      ...
      'api::variant-group.variant-group': ApiVariantGroupVariantGroup;
